...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
        <div>
            ...
            <p class="mt-1 text-gray-600 dark:text-gray-400">Temukan dan terhubung dengan profesional berbakat.</p>
        </div>
    </div>
    ...
    @if($talents->count() > 0)
        <div class="mb-6">
            <p class="text-gray-600 dark:text-gray-400">Ditemukan {{ $talents->total() }} talent{{ $talents->total() > 1 ? '' : '' }}</p>
        </div>
    @endif
                    ...
                    <div class="p-6 flex flex-col h-full">
                        ...
                        <div class="flex items-center text-gray-600 dark:text-gray-400 mb-6 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
                            ...
                            <span class="text-sm truncate font-medium">
                                {{ $talent->domicile_city ?? 'Kota tidak ditentukan' }}, {{ $talent->domicile_country ?? 'Negara tidak ditentukan' }}
                            </span>
                        </div>
                        ...
                        <div class="mb-6 flex-grow">
                            ...
                            @else
                                <p class="text-sm text-gray-500 dark:text-gray-400 italic">Tidak ada keahlian yang tercantum</p>
                            @endif
                        </div>
    ...
    @else
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-12 text-center">
            ...
            <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">Tidak ada talent ditemukan</h3>
            <p class="text-gray-600 dark:text-gray-400 mb-6 max-w-md mx-auto">
                Kami tidak dapat menemukan talent yang sesuai dengan kriteria Anda. Coba sesuaikan filter pencarian atau jelajahi semua talent yang tersedia.
            </p>
            <a href="{{ route('user.talents.index') }}"
               class="inline-flex items-center px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors">
                Jelajahi Semua Talent
            </a>
        </div>
    @endif
</div>
...
function sendRequest(talentId) {
    // Ini biasanya akan membuka modal atau mengarahkan ke formulir permintaan
    alert('Fitur kirim permintaan untuk Talent ID ' + talentId + ' akan segera tersedia.');
}
</script>
</x-layouts.app>
