...
<x-layouts.app :title="__('Dashboard')">
    <div class="flex h-full w-full flex-1 flex-col gap-6 p-4 md:p-6">
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div
                class="relative z-0 flex min-h-[200px] flex-col items-start justify-between gap-4 overflow-hidden rounded-lg border border-neutral-200 bg-gray-50 p-6 shadow-sm dark:border-neutral-700 dark:bg-gray-800"
            ...
            >
                ...
                <div class="relative z-10 mt-auto">
                    <a href="{{ route('user.talents.index') }}" class="inline-flex items-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm transition duration-150 ease-in-out hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800">
            ...
            <div class="flex flex-col rounded-lg border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-gray-800">
                ...
                <div class="flex flex-col space-y-6">
                    <div class="flex flex-col space-y-2">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <p class="text-sm text-gray-900 dark:text-white">PUI PT IS-IoT</p>
                        </div>
                    </div>
                    <div class="flex flex-col space-y-2">
                        <label class="text-xs font-medium text-gray-500 dark:text-gray-400">Nomor telefon</label>
                        <div class="flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="h-5 w-5 text-gray-400 dark:text-gray-500">
        ...
        {{-- Competency Chart --}}
        <div class="col-span-full rounded-lg border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-gray-800">
            <div class="flex items-center justify-between mb-4">
                <h2 class="text-md font-medium text-gray-900 dark:text-white">
                    Distribusi Talent Berdasarkan Keahlian
                </h2>
            </div>
            <div class="relative h-64 md:h-96 lg:h-[32rem] w-full">
